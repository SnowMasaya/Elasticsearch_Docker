...
if __name__ == '__main__':
    ...
    parser.add_argument('--xml_file', '-xml', default='jawiki-20160901-abstract.xml',
                        help='set xml file')
    args = parser.parse_args()
    wikipedia_abstract_xml = APP_ROOT + "/Data/split_data/" + args.xml_file
    wiki_pedia_xml_to_json = WikiPediaXmlToJson(wikipedia_abstract_xml)
    wiki_pedia_xml_to_json.input()
    wiki_pedia_xml_to_json.extract_contents()
